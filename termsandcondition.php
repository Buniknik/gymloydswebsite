                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav mx-auto py-0">
                            ...
                            <a href="#about" class="nav-item scroll nav-link">About</a>
                            <a href="#services" class="nav-item scroll nav-link">Service</a>
                        ...
                        <a href="form1.php" class="btn btn-primary rounded-pill py-1 px-3">BECOME A MEMBER</a>
                    </div>
                </nav>
            </div>
        </div>
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="accordion-item accordion-card">
                                <h2 class="accordion-header" id="headingOne">
                                    <a class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                        ...
                                        <span class="icon-button ml-auto"></i></span>
                                    </a>
                                </h2>
                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p>These terms and conditions outline the rules and regulations for membership at Loyd's Fitness Gym, including eligibility, fees, and cancellation procedures.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item accordion-card">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p>Our Privacy Policy explains how we collect, use, and protect your personal information when you join and use our services at Loyd's Fitness Gym.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item accordion-card">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p>This general policy outlines the rules of conduct, facility usage, and safety protocols that all members must adhere to while at Loyd's Fitness Gym.</p>
                                    </div>
                                </div>
                            </div>
